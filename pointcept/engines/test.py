        ...
        for idx, data_dict in enumerate(self.test_loader):
            ...
            if os.path.isfile(pred_save_path):
                ...
                for i in range(len(fragment_list)):
                    ...
                    with torch.no_grad():
                        if 'grid_sizes' in self.cfg.model.get('backbone', {}):
                        # if self.cfg.model['backbone']['grid_sizes'] is not None:
                            input_dict = pre_sample(input_dict, self.cfg.model['backbone']['grid_sizes'])
